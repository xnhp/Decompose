...
plt.axvline(1/2, color="red", label="Majority vote threshold", alpha=0.6)
...
alpha = 0.2
ax = plt.gca()
plt.axvspan(0, 1/2, color="green", alpha=alpha, label="$X_+$ (ensemble correct)", ymin=-0.025, ymax=0.025)
plt.axvspan(1/2, 1, color="orange", alpha=alpha, label="$X_-$ (ensemble incorrect)", ymin=-0.025, ymax=0.025)
